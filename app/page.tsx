...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-inherit relative overflow-x-hidden font-sans" role="main">
      ...
      <div className="sticky top-0 z-50 pt-6 pb-2 px-4 flex justify-center">
        ...
        <nav
          className="rounded-2xl border-none overflow-hidden transition-all duration-500 bg-black/40"
          style={{
      ...
      <section ref={heroRef} id="home" className="pt-40 pb-32 px-6 lg:px-8 relative">
        <div className="max-w-6xl mx-auto relative z-10">
          <h1 className="text-6xl md:text-8xl lg:text-[10rem] font-bold leading-[0.95] tracking-tight text-white animate-fade-in">
            Web{" "}
          ...
          <p className="mt-8 max-w-xl text-xl md:text-2xl text-white/70 leading-relaxed animate-slide-left delay-100">
      ...
      <section ref={aboutRef} id="about" className="pt-32 pb-24 px-6 lg:px-8 relative overflow-hidden">
        <div ref={aboutWrapRef} className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
          <p ref={aboutP1Ref} className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white/90 leading-tight mb-5 text-center">
            I&apos;m a passionate web developer with expertise in building modern, scalable web applications.
            I love turning complex problems into simple, beautiful, and intuitive solutions.
          </p>
          <p ref={aboutP2Ref} className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white/90 leading-tight text-center">
      ...
      <section id="skills" className="py-24 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-4 text-center uppercase">SKILLS</h2>
          <p className="text-white/60 text-sm uppercase tracking-widest mb-10 text-center">What I work with</p>
      ...
      <section id="projects" className="py-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="lg:hidden mb-6">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-white uppercase">PROJECTS</h2>
          <p className="text-white/60 text-xs uppercase tracking-widest mt-1">What I&apos;ve built</p>
        </div>
          ...
          <div className="slider__overlay">
            <div className="slider__overlay-inner">
              <div className="slider__overlay-header">
                <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-1 uppercase">PROJECTS</h2>
                <p className="text-white/60 text-sm uppercase tracking-widest">What I&apos;ve built</p>
              </div>
      ...
      <section id="contact" className="py-24 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-white/60 text-sm uppercase tracking-widest mb-4">Let&apos;s connect</p>
      ...
      <footer className="py-10 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto flex flex-col justify-center items-center gap-4 text-center w-full">
          ...
          <div className="flex gap-6">
            <a href="https://github.com/esqukev" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-white/60 hover:text-white transition-colors">
            ...
            <a href="https://www.linkedin.com/in/kevin-bermudez-831442241/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-white/60 hover:text-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </a>
            <a href="https://wa.me/50661371097" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-white/60 hover:text-white transition-colors">
      ...
      {/* Asterisk - left edge (bajado 320px, 250px a la izq, inclinado 40% derecha) */}
      <div className="asterisk-hover-zone asterisk-left absolute -left-[250px] top-[calc(80%_+_320px)] w-40 h-40 z-[25] select-none" aria-hidden>
        <div
